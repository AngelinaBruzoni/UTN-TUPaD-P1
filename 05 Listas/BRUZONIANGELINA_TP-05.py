...
multiplos_4 = list(range (0,101,4))
print(multiplos_4)

#2-Crear una lista con cinco elementos (colocar los elementos que más te gusten) y 
#  mostrar el penúltimo. ¡Puedes hacerlo como se muestra en los videos o bien investigar
...
# El anterior código imprime todos los números de la lista "numeros" excepto el mayor.
